...
//Write javascript code to addItemToCart function
//This function will get the selected item and add it to the cart table
//This function also update and add the selected item to the local storage which stors the cart data
//This function also update the total price in the cart
//This function also check if the item is already in the cart, if so, it will increase the quantity by 1

//The cart data is stored in the local storage as an array of objects
//  Each object in the cart array has the following properties: "id", "title", "price", "quantity", "totalPrice"
//  The "quantity" is the number of items in the cart
//  The "totalPrice" is the price of the item multiplied by the quantity
//  The local storage key for the cart data is "danielCart"
